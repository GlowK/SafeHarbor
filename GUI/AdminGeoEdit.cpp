...
AdminGeoEdit::AdminGeoEdit(AdminEditHarbour *parent) :
    QDialog(parent),
    ui(new Ui::AdminGeoEdit)
{
    ui->setupUi(this);
...
AdminGeoEdit::~AdminGeoEdit()
{
    delete ui;
}

double * AdminGeoEdit::getGeoCoordinates(QString cityName){
...
void AdminGeoEdit::connectGeoNameSS(QString cityName){
...
void AdminGeoEdit::connectGeoSS(QString cityName, double latitude, double longitude){
    /*
     * connect(
...
void AdminGeoEdit::on_pushButtonShanghai_clicked()
{
...
void AdminGeoEdit::on_pushButtonSingapore_clicked()
{
...
void AdminGeoEdit::on_pushButtonBoston_clicked()
{
...
void AdminGeoEdit::on_pushButtonRotterdam_clicked()
{
...
void AdminGeoEdit::on_pushButtonSydney_clicked()
{
...
void AdminGeoEdit::on_pushButtonHouston_clicked()
{
...
int AdminGeoEdit::isCreated(QString cityName){
...
void AdminGeoEdit::isButtonVisible(QString cityName, int j){
...
void AdminGeoEdit::checkButtonsVisibilitie(QString arr[]){
    SQLConnect::ConnectToDB();
